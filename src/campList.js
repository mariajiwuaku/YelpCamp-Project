  ...
  campgrounds.forEach((campground) => {
    ...
    <div class="rounded-lg border border-black-600">
      ...
      <img class="rounded-t-lg w-full p-4" src="${campground.imageSrc}" alt="${campground.name}" />
        <h5 class="mb-2 text-lg md:text-xl font-bold leading-tight text-neutral-800 dark:text-neutral-50">
          ${campground.name}
        </h5>
        ...
        <button class="block w-full md:inline-block md:w-auto h-10 md:h-12 px-4 md:px-6 font-bold rounded-lg border border-black-600 text-black-600"
